...
/* Data to input */
const byte testData1[3] PROGMEM = { 'A', 'B', 'C' };
const byte testData2[4] PROGMEM = { 's', 'p', 'a', 'm' };
const byte testData3[7] PROGMEM = { 'a', 'r', 'c', 'f', 'o', 'u', 'r' };

/* Test vectors */
/* Data 'ABC' hash test vectors */
const byte testVector1[32] PROGMEM =
...
const byte testVector2[32] PROGMEM =
...
const byte testVector3[32] PROGMEM =
...
const char warnMsg[] PROGMEM = "** WARNING: Output != Test_Vector **";
